...
//                 }else{
//                     m_authorization += 7;
//                     // std::cout<<m_authorization<<std::endl;
...
//                         // 处理内存分配失败
//                     }
//                     // std::strcpy(m_apikey, m_authorization);
//                     // if(redis){
//                     //     std::cout<<"999888"<<std::endl;
//                     // } 
//                     m_lock.lock();
//                     // 选择指定的数据库
//                     std::cerr << "eee1" << std::endl;
//                     // redisReply* reply = static_cast<redisReply*>(redisCommand(redis, "SELECT %d", 3));
//                     // if (reply == nullptr) {
//                     //     std::cerr << "执行 SELECT 命令时出错" << std::endl;
//                     //     m_lock.unlock();
...
//                         // std::cout << m_apikey_max << std::endl;
...
//             // std::cout<<data["messages"].get<nlohmann::json>()<<std::endl;
...
//             // if(data.contains("messages") && data["messages"].contains("content")){
//             //     // chat(["content"], m_sockfd);
//             // } 
